      ...
      <footer className="footer">
        <div className="container">
          <div className="footer__content">
            ...
            <div className="footer__company">
              ...
              <p>
                ...
                businesses grow through thoughtful design and reliable
                technology.
              </p>
          ...
          <div className="footer__bottom">
            <p>© {new Date().getFullYear()} Scaalable. All rights reserved.</p>
            ...
            <div className="footer__legal">
              ...
              <button onClick={() => openModal("refund")}>Refund Policy</button>
              <button onClick={() => openModal("cookie")}>Cookie Policy</button>
